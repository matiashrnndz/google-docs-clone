...
@Injectable()
export class GraphDocumentModificationService extends CatchService {

    private WEB_API_URL : string = 'api/documentmodificationgraphic';
    ...
    constructor(
        ...
        super();
        this.message = "Graph Document Modification error";
        var config = new AppConfig();
        this.WEB_API_URL = config.getUrl() + this.WEB_API_URL;
        this.options = config.getRequestOptions();
    }

    get(startingDate: string, lastestDate: string, userEmail: string): Observable<Array<Coordinate>> {
