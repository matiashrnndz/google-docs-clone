...
@Component({
    selector: 'app-footer-text-update',
    templateUrl: './footer-text-update.component.html',
    styleUrls: ['./footer-text-update.component.css'],
    providers: [StyleClassService, TextService]
})
export class FooterTextUpdateComponent extends ShowErrorComponent implements OnInit {
    ...
    constructor(
        public dialogRef: MatDialogRef<FooterTextUpdateComponent>,
